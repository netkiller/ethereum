...
public class Ethereum {
	private static final String key = "sdFGYtjfGKHdfpo8";
	private static final String passphrase = "passw0rd";
	...
	public WalletResponse createMnemonic() throws UnreadableWalletException {
		...
		WalletResponse wallet = new WalletResponse(Ethereum.key);
	...
	public class WalletResponse {
		...
		public void setMnemonic(String mnemonic) {
			if (aes == null) {
				...
				this.mnemonic = aes.encrypt(mnemonic);
			}
	...
	public static void main(String[] args) throws UnreadableWalletException {
		...
		AES aes = new AES(key);
		WalletResponse wallet = eth.createMnemonic();
		System.out.println(wallet);
		System.out.println(eth.importFromMnemonic(aes.decrypt(wallet.getMnemonic())));
		System.out.println(aes.decrypt(wallet.getMnemonic()));
		System.out.println(aes.decrypt(wallet.getPrivateKey()));
		System.out.println(eth.importFromPrivateKey(aes.decrypt(wallet.getPrivateKey())));

		// System.out.println(eth.importFromMnemonic("canal film bottom misery wash used trap tent brisk quiz monster thank"));
		// System.out.println(eth.importFromPrivateKey("0x85d9b80134970dca18b17a513715594c075a4363ca6f2f705236dae5e57442e5"));

		System.out.println(aes.decrypt("ur577pJKfSN4Ax5pxcjBoeSAvpu8CrkdoTrcDJcKzxUJJ7nj7sP8SxYVaWeG6J6iGcSqpWziZaBuWJBmeoZrdZonDBCk6rXfxqwNkjuRn1JGW"));

		System.out.println(aes.decrypt("2X4xD3gdX7koFtRky3giDzCpZzbaWce2B3cP39kXgqZCRHQ4ST4BiwdWFEehMkZfKm33ChZckiw3BKWeSZBco9ZGJuRYFUh9Z1uGsRgmmkVm6P"));
